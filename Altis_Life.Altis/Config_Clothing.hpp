...
class Clothing {
    ...
    class cop {
        ...
        uniforms[] = {
			...
			{ "U_Competitor", "Sheriff Uniform", 0, { "", "", -1 } },
			{ "U_Marshal", "Supervisor", 0, { "", "", -1 } }
        };
        headgear[] = {
			{ "NONE", "Remove Hat", 0, { "", "", -1 } },
            { "H_Cap_police", "Police Hat", 0, { "", "", -1 } },
			{ "A3M_Leo_SherHat", "Sheriff Hat", 0, { "", "", -1 } }
        };
        goggles[] = {
            { "NONE", "Remove Glasses", 0, { "", "", -1 } },
            { "G_Aviator", "", 0, { "", "", -1 } },
        ...
        vests[] = {
            { "NONE", "Remove Vest", 0, { "", "", -1 } },
            { "demian2435_police_belt", "Duty Belt", 0, { "", "", -1 } },
			{ "A3M_PoliceBelt_D", "Police Belt ", 0, { "", "", -1 } },
            { "TRYK_V_Sheriff_BA_OD", "Sheriff Vest", 0, { "life_coplevel", "SCALAR", 1 } }
        };
        backpacks[] = {
            { "NONE", "Remove Backpack", 0, { "", "", -1 } }
        };
